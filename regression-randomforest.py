...
plt.scatter(y_train, y_train_pred, c='crimson', label='Training Data')
...
plt.title("Random Forest Regression: True Values vs Predicted for Training ")
plt.axis('equal')
# plt.legend()

plt.figure(2, figsize=(10,10))
plt.scatter(y_test, y_test_pred, c='crimson', label='Test Data')
...
plt.xlabel('True Values', fontsize=15)
plt.ylabel('Predicted', fontsize=15)
plt.title("Random Forest Regression: True Values vs Predicted for Testing")
plt.axis('equal')
# plt.legend()
